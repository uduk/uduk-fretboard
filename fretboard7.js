...
UdukFretboard7 = function(x, y) {
  ...
  /* string tuning */
	...
	{
	  // 3, 5, 7, 9
		var myCircle = new Path.Circle(new Point(d1+this.posX, 91+this.posY), 10);
		myCircle.fillColor = 'grey';

		// 15. 17, 19, 21
		var myCircle = new Path.Circle(new Point(d2+this.posX, 91+this.posY), 10);
		myCircle.fillColor = 'grey';
	}

  // 12
	var myCircle = new Path.Circle(new Point(460+this.posX, 61+this.posY), 10);
	myCircle.fillColor = 'grey';
	var myCircle = new Path.Circle(new Point(460+this.posX, 121+this.posY), 10);
	myCircle.fillColor = 'grey';

	//	24
	var myCircle = new Path.Circle(new Point(940+this.posX, 61+this.posY), 10);
	myCircle.fillColor = 'black';
	var myCircle = new Path.Circle(new Point(940+this.posX, 121+this.posY), 10);
	myCircle.fillColor = 'black';
